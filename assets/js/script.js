/*======================================================================
Hide file form fields
//========================================================================*/
//function fileForm(){
//    document.getElementById('id_uploaded_by').style.display = 'none';
//    document.getElementById('id_department').style.display = 'none';
//    document.getElementById('id_is_task').style.display = 'none';
//    document.getElementById('id_faculty').style.display = 'none';
//    document.getElementById('id_folder').style.display = 'none';
//    document.getElementById('id_is_rep').style.display = 'none';
//}
